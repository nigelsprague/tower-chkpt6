  ...
  <form @submit.prevent="createEvent()" class="row m-0">
    ...
    <div class="mb-3 col-md-4">
      <div class="mb-2 row">
        ...
        <input v-model="eventData.eventName" required class="form-control" type="text" minlength="3" maxlength="50"
          name="eventName" id="eventName" placeholder="Name...">
      </div>
      <div class="mb-2 row">
        <label class="" for="eventLocation">Event Location</label>
        <input v-model="eventData.eventLocation" required class="form-control" type="text" minlength="1" maxlength="500"
          name="eventLocation" id="eventLocation" placeholder="Location...">
      </div>
      <div class="mb-2 row">
        <label class="" for="eventType">Event Type</label>
        <select v-model="eventData.eventType" required class="form-control text-center" name="eventType" id="eventType">
      ...
      <div class="mb-2 row gap-3">
        <div class="col-8 p-0">
          ...
          <input v-model="eventData.eventDate" required class="form-control" type="date" id="eventDate"
            name="eventDate">
        </div>
        <div class="col p-0">
          <label for="eventCapacity">Capacity</label>
          <input v-model="eventData.eventCapacity" required class="form-control" type="number" min="3" max="5000"
            name="eventCapacity" id="eventCapacity" placeholder="0">
        </div>
      </div>
      <div class="mb-2 row">
        <label class="" for="eventImg">Image Url</label>
        <input v-model="eventData.eventImg" required class="form-control" type="url" minlength="3" maxlength="500"
          name="eventImg" id="eventImg" placeholder="URL...">
      </div>
    </div>
    <div class="mb-2 row m-0 p-0">
      <label class="" for="eventDesc">Event Description</label>
      <textarea v-model="eventData.eventDesc" required class="form-control" name="eventDesc" id="eventDesc"
